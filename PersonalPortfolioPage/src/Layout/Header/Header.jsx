...
const Header = ({ isAboutPageVisible, isContactPageVisible, isSkillsPageVisible, isProjectsPageVisible }) => {
  ...
  return (
    ...
    sticky top-0 px-4 font-semibold text-sm text-slate-900 dark:text-white bg-slate-50/90 dark:bg-slate-700/90 backdrop-blur-sm ring-1 ring-slate-900/10 dark:ring-white/10 z-10"
    >
