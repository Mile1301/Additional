...
const ProjectPage = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h2 className="text-3xl font-bold tracki text-center sm:text-5xl dark:text-gray-50">My Projects</h2>
        <p className="max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-400"></p>
      </div>
      <div className="mt-10 grid lg:gap-8 lg:grid-cols-2 lg:items-center">
        <div>
          <h3 className="text-2xl font-bold tracki sm:text-3xl dark:text-gray-50">FocushHub</h3>
          ...
          <div className="mt-12 space-y-12">
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leadi dark:text-gray-50">It's a productivity App in its core</h4>
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leadi dark:text-gray-50">
                  No hiding behind tables and solid numbers - always we can achieve more.
                </h4>
                <p className="mt-2 dark:text-gray-400">
      ...
      <div>
        <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
          <div className="lg:col-start-2">
            <h3 className="text-2xl font-bold tracki sm:text-3xl dark:text-gray-50">To-Do Platform</h3>
            <p className="mt-3 text-lg dark:text-gray-400">
            ...
            <div className="mt-12 space-y-12">
              <div className="flex">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium leadi dark:text-gray-50">Problem</h4>
                  <p className="mt-2 dark:text-gray-400">
              ...
              <div className="flex">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium leadi dark:text-gray-50">Solution</h4>
                  <p className="mt-2 dark:text-gray-400">
                    Know the price, get discount, arrange time, find reliable craftsmen based on real ratings and comments
                  </p>
                </div>
              </div>
              <div className="flex">
                ...
                <div className="ml-4">
                  <h4 className="text-lg font-medium leadi dark:text-gray-50">Changing the mindset</h4>
                  <p className="mt-2 dark:text-gray-400">
          ...
          <div className="flex flex-row mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
            <a id="todoPitch" href={todoPitch} download={todoPitch}>
              <img src="../../../public/todoPitchBg.png" width={560} alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
